...
ALTER TABLE "public"."comentario" ADD CONSTRAINT "comentario_projecto_id_fkey" ADD FOREIGN KEY ("projecto_id") REFERENCES "public"."projecto" ("id") ON DELETE CASCADE ON UPDATE NO ACTION;
